...
/* The common main class will remain the location for the to-do list. This will work in tandem with intellisense
* and give contributors things to set their sights on if they wish to help. This probably isn't necessary, but it helps me at least.*/

//TODO
// Move Forge specific data in the forge Subproject.
// Add Prospector's picks.
// Stop propicks from working if the tool has the blocking ability.
// Add Chisels.
// Add Saws.
